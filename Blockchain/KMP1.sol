...
*/    
    ...
    function grantAdminAccess(address _addresss) public onlyAdmin{
        isAdmin[_addresss]=1;
        emit central_monitoring("_id",block.timestamp,"admins",msg.sender, "grantAdminAccess + _addresss");
    }
/*
...
*/  function registerApplicant(string memory _id, string memory _name, string memory _Haddress, string memory _telephone, string memory _nationality) public{
        ...
        emit central_monitoring(_id,block.timestamp,"name",msg.sender, "register + applicantId");
...
*/
    function AIapprove(string memory _id, string memory _approverName) public onlyAdmin{
        ...
        AIapproval[_id]=true;
        emit central_monitoring(_id,block.timestamp, _approverName, msg.sender, "AIapproved +_id");
    ...
    function DOASapprove(string memory _id, string memory _approverName) public onlyAdmin{
        ...
        emit central_monitoring(_id,block.timestamp,"DOAS", msg.sender, "DOASapprove + _id");
    ...
    function DGapprove(string memory _id, string memory _approverName) public onlyAdmin{
        ...
        DGapproval[_id]=true;
        emit central_monitoring(_id,block.timestamp,"DG", msg.sender,"DGapprove + _id");
    ...
    function grantLicense(string memory _id, string memory _license) public onlyAdmin{
        ...
        emit central_monitoring(_id,block.timestamp,"DG + DOAS + AI", msg.sender,"grantLicense + _id" );
