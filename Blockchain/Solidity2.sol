...
*/     
    function updateapplication(string memory _id ,address addapplicant) public{
        
        applicantDetails[_id]= registerApplicant(_id,_name,_Haddress,_telephone,_nationality);
    
       string memory work1 = "updateApplicant".toSlice().concat("applicantId".toSlice());
       emit central_monitoring(_id,block.timestamp,"name",msg.sender,work1);
        
    }
        
    function updateraerodrome(string memory _id ,address addapplicant) public{
        applicantAerodrome[_id]= registerAerodrome( _id1, _aerodromeName1, _aerodromeOwner1, _latitude1, _longitude1, _district_state1, _category1);
