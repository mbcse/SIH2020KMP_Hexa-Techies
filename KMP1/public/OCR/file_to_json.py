...
def main(file_name):
    ...
    result['csvFilename']=output_file_name
    print(json.dumps(result))
    
    #os.mkdir(output_file_name)
    shutil.move(csv_output_file,"./public/OCR_outputs"+'/'+csv_output_file)
    shutil.move(json_output_file,"./public/OCR_outputs"+'/'+json_output_file)
